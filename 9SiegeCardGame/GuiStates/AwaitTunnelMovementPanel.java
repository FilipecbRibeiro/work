 ...
 * @author morei
 */
public class AwaitTunnelMovementPanel extends JPanel implements Observer {
    ...
    public AwaitTunnelMovementPanel(ObservableGame game) {
        this.game = game;
    ...
    private void setup() {
        ...
        escolhe1 = new JRadioButton("free");
        escolhe1.addActionListener(new AwaitTunnelMovementPanel.escolhe1Listener());
        escolhe2 = new JRadioButton("fast");
        escolhe2.addActionListener(new AwaitTunnelMovementPanel.escolhe2Listener());
        escolhe3 = new JRadioButton("automatic");
        escolhe3.addActionListener(new AwaitTunnelMovementPanel.escolhe3Listener());
    ...
    public void update(Observable o, Object arg) {
        ...
        setVisible(game.getState() instanceof AwaitSelectionTunnelMovement);

        if (game.getState() instanceof AwaitSelectionTunnelMovement) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        System.out.println("\n" + game.getGameData().getForte().toString() +  "\n");

...
import GuiStates.AwaitActionPanel.escolhe2Listener;
 ...
 * @author Asus
 */
public class AwaitArchersLocationPanel extends JPanel implements Observer {
    ...
    public AwaitArchersLocationPanel(ObservableGame game) {
        this.game = game;
    ...
    public void update(Observable o, Object arg) {
        ...
        setVisible(game.getState() instanceof AwaitSelectionArchersTrack);

        if (game.getState() instanceof AwaitSelectionArchersTrack) {

...
import DataStates.AwaitFirstPlay;
 ...
 * @author Asus
 */
public class AwaitFirstPlayPanel extends JPanel implements Observer{
 ...
 private JTextField position;
  private JTextField  posx;
   ...
   GridBagConstraints c2 = new GridBagConstraints();
    public AwaitFirstPlayPanel(ObservableGame game) {
        this.game = game;
    ...
    private void setUp() {
        ...
        playerrack = new JButton[ game.getGame().getPlayer().getYourRack().size()];
  ...
  wordtoplay = new JTextField(10);
       ...
       posy  = new JTextField(1);
        ...
        pressword.setAlignmentX(100);
        pressword.setAlignmentY(100);
           ...
           if( game.getGame().getPlayer().getYourRack().size()==0)
        {
           ...
           playerrack[i].setBorder(BorderFactory.createEmptyBorder());
            playerrack[i].setContentAreaFilled(false);
              ...
              for(int i = 0 ; i< game.getGameData().getPlayerRack().size(); i++)
              {
    ...
    public void update(Observable o, Object arg) {
      ...
      showtiles();
        setVisible(game.getState() instanceof AwaitFirstPlay);
    ...
    class playwordlistener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            char posit = position.getText().charAt(0);
           char posa = posx.getText().charAt(0);
            char posb=  posy.getText().charAt(0);
             int posxx = Character.getNumericValue(posa);
             int posyy = Character.getNumericValue(posb);
      
            game.firstplay(text,posit,posxx,posyy);
